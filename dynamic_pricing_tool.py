...
def init_session_state():
    ...
    if "weights" not in st.session_state:
        st.session_state.weights = {
            ...
            # Trendyol kategori BPS - dusuk komisyon = yuksek karlilik = daha az indirim
            # Supermarket/FMCG: en dusuk komisyon (%8-17) = en yuksek karlilik = en fazla indirim (-75 bps)
            # Giyim/Moda: yuksek komisyon (%21+) = dusuk karlilik = prim (+100 bps)
...
TRENDYOL_CATEGORIES = {
    "Supermarket / FMCG": {"key": "cat_supermarket", "komisyon": "%8-17", "karlilik": "⭐⭐⭐⭐⭐ Cok Yuksek"},
    "Kozmetik & Kisisel Bakim": {"key": "cat_kozmetik", "komisyon": "%12-17", "karlilik": "⭐⭐⭐⭐ Yuksek"},
    "Elektronik & Aksesuar": {"key": "cat_elektronik", "komisyon": "%7-15", "karlilik": "⭐⭐⭐⭐ Yuksek"},
    ...
    "Giyim & Moda": {"key": "cat_giyim_moda", "komisyon": "%21+", "karlilik": "⭐ Dusuk"},
    "Ayakkabi & Canta": {"key": "cat_ayakkabi_canta", "komisyon": "%21-23", "karlilik": "⭐ Dusuk"},
}
...
with tabs[4]:
    ...
    with col2:
        ...
        st.caption("Dusuk komisyon = Yuksek karlilik = Daha fazla indirim (negatif bps)")
        cat_table = []
